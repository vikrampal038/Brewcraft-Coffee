...
import { Calendar } from "../../Common/User/Calendar";
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <button
                      ...
                      className={`${baseClass} ${activeSeat === "window" ? activeClass : normalClass
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`${baseClass} ${activeSeat === "lounge" ? activeClass : normalClass
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`${baseClass} ${activeSeat === "outdoor" ? activeClass : normalClass
                        }`}
                    >
